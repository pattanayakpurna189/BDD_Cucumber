...
public class MB_Login  {
			...
			Thread.sleep(30000);
			 ...
			 flag = util.isDisplayed(util.getAppiumDriver(), login.UserName_And_Password_Login_Btn());
				 if(flag) {
					 ...
					 util.Click(CurrentMethod, util.getAppiumDriver(),login.UserName_And_Password_Login_Btn(),10);
				 ...
				 flag = util.isDisplayed(util.getAppiumDriver(), login.UserID());
					 ...
					 util.wait_for_Element_WithOutThrowing_Exception( util.getAppiumDriver(), login.Allow_SMS_Message(), 5);
					 flag = util.isDisplayed(util.getAppiumDriver(), login.Allow_SMS_Message());
						 ...
						 util.wait_for_Element_WithOutThrowing_Exception( util.getAppiumDriver(), login.OTP_Header(), 10);
						 ...
						 flag = util.isDisplayed(util.getAppiumDriver(), login.Allow_Location_Message());
							 ...
							 util.wait_for_Element_WithOutThrowing_Exception( util.getAppiumDriver(), login.You_Have(), 5);
	...
	public void user_Logged_out_of_the_system_successfully() throws Throwable {
        ...
        util.wait_for_Element(CurrentMethod,util.getAppiumDriver(),homepage.Signin_Button(), 5);
